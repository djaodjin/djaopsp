...
urlpatterns = [
    url(r'^enable(?P<path>%s)/?' % settings.PATH_RE,
      EnableContentAPIView.as_view(), name="api_enable"),
    url(r'^disable(?P<path>%s)/?' % settings.PATH_RE,
      DisableContentAPIView.as_view(), name="api_disable"),
    url(r'^scorecard/enable(?P<path>%s)/?' % settings.PATH_RE,
      EnableScorecardAPIView.as_view(), name="api_scorecard_enable"),
    url(r'^scorecard/disable(?P<path>%s)/?' % settings.PATH_RE,
