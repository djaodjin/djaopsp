...
class CompletionRateMixin(DashboardAggregateMixin):
    ...
    @staticmethod
    def construct_weekly_period(at_time, years=0, timezone=None):
    ...
    def construct_weekly_periods(self,
                                 first_date=None, last_date=None, years=0):
        if not last_date:
        ...
        while at_time < last_date:
            ...
            start_at, ends_at = self.construct_weekly_period(
                at_time, years=years)
    ...
    def get_aggregate(self, account=None, labels=None, years=0):
        ...
        weekends_at = self.construct_weekly_periods(
            last_date=self.ends_at, years=years)
    ...
    def get_response_data(self, request, *args, **kwargs):
        # Uses `Subscription` to find the alliances the organization belongs to.
...
class CompletionRateAPIView(CompletionRateMixin, generics.RetrieveAPIView):
    ...
    **Examples**
    ...
    .. code-block:: http
        ...
        GET /api/energy-utility/reporting/completion-rate HTTP/1.1
...
class GoalsAPIView(GoalsMixin, generics.RetrieveAPIView):
    ...
    **Examples**
    ...
    .. code-block:: http
        ...
        GET /api/energy-utility/reporting/goals HTTP/1.1
...
class BySegmentsAPIView(BySegmentsMixin, generics.RetrieveAPIView):
    ...
    **Examples**
    ...
    .. code-block:: http
        ...
        GET /api/energy-utility/reporting/by-segments HTTP/1.1
...
class GHGEmissionsRateAPIView(GHGEmissionsRateMixin, generics.RetrieveAPIView):
    ...
    **Examples**
    ...
    .. code-block:: http
        ...
        GET /api/energy-utility/reporting/ghg-emissions-rate HTTP/1.1
...
WHERE survey_question.path LIKE '%%%(path)s'
  ...
  AND survey_answer.unit_id = (SELECT id FROM survey_unit WHERE slug='tons-year')
""" % {'path': path,
       'account_ids': ','.join([str(pk) for pk in accounts]),
       'ends_at': ends_at}
...
class GHGEmissionsAmountAPIView(GHGEmissionsAmountMixin,
    ...
    **Examples**
    ...
    .. code-block:: http
        ...
        GET /api/energy-utility/reporting/ghg-emissions-amount HTTP/1.1
