...
RUN /app/bin/pip install "botocore[crt]"==1.43.12 Django==5.2.14 django-csp==4.0 djangorestframework==3.16.1 djaodjin-deployutils==0.14.5 djaodjin-extended-templates==0.5.4 djaodjin-pages==0.9.2 djaodjin-survey==0.20.1 docutils==0.21.2 drf-spectacular==0.27.2 gunicorn==23.0.0 jinja2==3.1.6 monotonic==1.6 openpyxl==3.1.5 python-pptx==0.6.21 pytz==2026.1 django-debug-toolbar==3.8.1 django-extensions==3.2.3 Faker==2.0.0 sqlparse==0.5.5
