...
RUN /app/bin/pip install Django==3.2.25 djangorestframework==3.12.4 djaodjin-deployutils==0.11.0 djaodjin-extended-templates==0.4.5 djaodjin-pages==0.8.2 djaodjin-survey==0.12.1 docutils==0.20.1 drf-spectacular==0.27.0 gunicorn==20.1.0 jinja2==3.1.2 html5lib==1.1 monotonic==1.6 openpyxl==3.1.2 python-pptx==0.6.21 pytz==2023.3 django-debug-toolbar==3.5.0 django-extensions==3.2.0 Faker==2.0.0 sqlparse==0.4.4
