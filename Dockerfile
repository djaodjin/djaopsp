...
RUN /app/bin/pip install Django==4.2.28 djangorestframework==3.15.2 djaodjin-deployutils==0.14.2 djaodjin-extended-templates==0.4.11 djaodjin-pages==0.8.8 djaodjin-survey==0.18.0 docutils==0.20.1 drf-spectacular==0.27.2 gunicorn==23.0.0 jinja2==3.1.6 monotonic==1.6 openpyxl==3.1.5 python-pptx==0.6.21 pytz==2025.2 django-debug-toolbar==3.8.1 django-extensions==3.2.3 Faker==2.0.0 sqlparse==0.5.3
