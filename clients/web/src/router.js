...
export default new Router({
  ...
  routes: [
    ...
    {
      path: '/:org/assess/:id/content/:samplePath/',
    ...
    {
      path: '/:org/targets/:id/intro/:samplePath/',
      name: 'introTargets',
    ...
    {
      path: '/:org/targets/:id/content/:samplePath/',
    ...
    {
      path: '/:org/improve/:id/intro/:samplePath/',
      name: 'introPlan',
    ...
    {
      path: '/:org/improve/:id/content/:samplePath/',
      name: 'assessmentPlan',
    ...
    {
      path: '/:org/scorecard/:id/content/:samplePath/',
    ...
    {
      path: '/:org/share/:id/content/:samplePath/',
